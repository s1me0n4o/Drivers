...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAudio : MonoBehaviour
    {
        ...
        public static float pitchMultiplier = 1f;                                          // Used for altering the pitch of audio clips
        public static float lowPitchMin = 1f;                                              // The lowest possible pitch for the low sounds
        public static float lowPitchMax = 6f;                                              // The highest possible pitch for the low sounds
